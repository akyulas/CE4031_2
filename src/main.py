...
result_1, success_1 = postgres_wrapper.get_query_plan_of_query("select * from lineitem;")
result_2, success_2 = postgres_wrapper_2.get_query_plan_of_query("select * from customer where c_nationkey > 0;")

print(result_1)
print(result_2)

if success_1 and success_2:
    print(find_difference_between_two_query_plans(result_1, result_2))
